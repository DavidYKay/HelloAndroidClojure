(defproject HelloClojure/HelloClojure "0.0.1-SNAPSHOT"
             ...
             [:android-common :android-user
              {:dependencies [[org.clojure-android/tools.nrepl "0.2.6"]]
               ...
               :android {:aot :all-with-unused
                         :rename-manifest-package "com.davidykay.helloclojure.debug"
                         :manifest-options {:app-name "HelloClojure - debug"}}}]
             :release
             [:android-common
