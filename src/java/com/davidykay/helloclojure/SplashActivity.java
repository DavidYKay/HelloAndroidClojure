package com.davidykay.helloclojure;
...
import com.davidykay.helloclojure.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.davidykay.helloclojure.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.davidykay.helloclojure.MainActivity");
